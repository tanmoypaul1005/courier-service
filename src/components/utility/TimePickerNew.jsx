...
function TimePickerNew({ init_time = null, endTime = null, selectAction }) {
    ...
    return (
        <div className='bg-white px-5 rounded-lg inline-block text-gray-700'>
            ...
            <div className='flex justify-between items-center rounded-br5 text-2xl mx-2 mb-2 bg-gray-200 select-none'>
